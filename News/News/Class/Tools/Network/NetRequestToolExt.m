...
#import "NetRequestToolExt.h"
#import "DataStoreManager.h"

@implementation NetRequestToolExt
+ (NetRequestToolExt*)shared{
    static NetRequestToolExt *requestExt = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        requestExt = [[NetRequestToolExt alloc]init];
    });
    return requestExt;
}

-(instancetype)init {
    self = [super initWithBaseURL:[NSURL URLWithString:ArticleBASEURL]];
    if(self)
    {
